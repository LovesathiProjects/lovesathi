-- Phone is mandatory for Lovesathi accounts, but OTP verification can happen later
-- from Edit Profile. Keep the verified timestamp for trust features without blocking
