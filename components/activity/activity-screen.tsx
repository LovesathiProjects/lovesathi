      ...
      <div className={cn(
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <p className="luxe-kicker text-[0.62rem] text-[#E83262]">interest ledger</p>
              <h1 className={cn("font-serif text-3xl font-bold tracking-[-0.05em]", isMatrimony ? "text-[#26364A]" : "text-white")}>Activity</h1>
            </div>
          </div>
            ...
            {tabs.map((tab) => (
              <button
                ...
                className={cn(
                  ...
                  activeTab === tab.id
                    ? "bg-[#E83262] text-white shadow-[0_12px_28px_rgba(194,165,116,0.22)]"
                    : isMatrimony 
                      ? "border border-[#482b1a]/10 bg-white/70 text-[#6F7C8B] hover:bg-white"
          ...
          <div className="space-y-3">
              ...
              <div
                ...
                className={cn(
                  ...
                  isMatrimony 
                    ? "luxe-card border-[#E83262]/24 hover:bg-[#ffffff]"
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    {maskedView && (
                      <div className="absolute inset-0 flex items-center justify-center rounded-full bg-[#26364A]/20 backdrop-blur-sm">
                        <Crown className="h-4 w-4 text-[#E83262]" />
                      </div>
                    )}
                  </div>
                  ...
                  {activity.type === 'match' && (
                    <Button
                      ...
                      className="bg-[#E83262] hover:bg-[#C3264E] text-white"
                    >
                      Chat
                    </Button>
                  )}
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          likedBack.has(activity.id)
                            ...
                            : isMatrimony
                              ? "bg-gray-100 border-[#E5E5E5] hover:border-[#E83262]"
                              : "bg-black/40 border-white/60 hover:border-white/80"
                        )}
                      >
                        {likingInProgress.has(activity.id) ? (
                          <Loader2 className={cn("w-4 h-4 animate-spin", isMatrimony ? "text-[#E83262]" : "text-white")} />
                        ) : (
                          <Heart
                            className={cn(
