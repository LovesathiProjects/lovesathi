...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "data-[placeholder]:text-[#6F7C8B]/65 [&_svg:not([class*='text-'])]:text-[#6F7C8B] focus-visible:border-[#E83262] focus-visible:ring-[#E83262]/18 aria-invalid:ring-[#E83262]/20 aria-invalid:border-[#E83262] flex w-full min-w-0 items-center justify-between gap-2 rounded-2xl border border-[#482b1a]/15 bg-white/95 px-4 py-3 text-sm font-semibold text-[#26364A] shadow-[inset_0_1px_0_rgba(255,255,255,0.9),0_10px_24px_rgba(24,17,13,0.04)] transition-all outline-none focus-visible:ring-[4px] disabled:cursor-not-allowed disabled:bg-[#F2F5FA]/60 disabled:opacity-60 data-[size=default]:h-[3.25rem] data-[size=sm]:h-10 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:min-w-0 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "data-[highlighted]:bg-[rgba(194,165,116,0.08)] data-[highlighted]:text-[#111]",
        // Disabled state
