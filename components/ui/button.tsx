...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-bold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-[4px] focus-visible:ring-[#d9b978]/28",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          'border border-[#482b1a]/18 bg-white/88 text-[#18110d] shadow-[0_10px_24px_rgba(24,17,13,0.05)] hover:border-[#b9904d] hover:bg-white hover:text-[#8f001c]',
        secondary:
          'border border-[#d9b978]/28 bg-white/88 text-[#18110d] shadow-[0_10px_24px_rgba(24,17,13,0.05)] hover:bg-white hover:text-[#8f001c]',
        ghost:
