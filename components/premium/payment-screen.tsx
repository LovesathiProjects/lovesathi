        ...
        <Card className="luxe-card w-full max-w-2xl rounded-[2rem] border-[#E83262]/24">
          ...
          <CardContent className="space-y-5">
            <p className="text-base leading-7 text-[#6F7C8B]">
              ...
              <span className="font-bold text-[#26364A]">{plan.priceLabel}</span> with the 70% forever discount. Before launch, this screen should be connected to a real payment provider with subscriptions,
