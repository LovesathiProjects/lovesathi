      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex-1 space-y-6">
          <div className="space-y-2">
            <h1 className="font-serif text-4xl font-bold tracking-[-0.05em] text-[#26364A] sm:text-5xl">A Few Words About You</h1>
            <p className="text-base leading-7 text-[#6F7C8B]">Write a warm introduction that helps families and serious matches understand your personality.</p>
          </div>
            ...
            <FormItem>
              ...
              <FormControl>
                <Textarea 
                  ...
                  {...field}
                  className="text-base text-[#111] placeholder:text-black/40 resize-none min-h-[250px] border-black/20 focus:border-[#E83262] focus:ring-2 focus:ring-[#E83262]/20 rounded-xl"
                />
              </FormControl>
            ...
            <div className="grid gap-3">
              {suggestions.map((suggestion, index) => (
                <button
                  ...
                  className="rounded-2xl border border-[#482b1a]/10 bg-white/70 p-3 text-left text-sm leading-6 text-[#6F7C8B] transition hover:border-[#E83262]/30 hover:text-[#26364A]"
                >
