      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        <div className="flex-1 space-y-6">
          <div className="space-y-2">
            <h1 className="font-serif text-4xl font-bold tracking-[-0.05em] text-[#26364A] sm:text-5xl">Family Information</h1>
            <p className="text-base leading-7 text-[#6F7C8B]">Share family context with the clarity and discretion expected in matrimony.</p>
          </div>
